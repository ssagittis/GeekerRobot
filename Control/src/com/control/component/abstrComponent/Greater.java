...
public class Greater extends AbstrComponent {

	public Greater(Context context,int width,int inputPos1,int inputPos2,int outputPos1) {
		super(context, width,"大于组件");
