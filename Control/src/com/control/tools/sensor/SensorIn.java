...
public class SensorIn extends Sensor{
	private static HashMap<Integer,SensorIn> sensors=new HashMap<Integer,SensorIn>();
	//private String sensorname;		//传感器的名称
	//public String getSensorname() {
	//	return sensorname;
	//}
	private InComponentBSensor ics=null;
	public InComponentBSensor getCom() {
		return ics;
	}
	public void setCom(InComponentBSensor ics) {
		this.ics = ics;
	}
	...
	public SensorIn(int sensorID){
		this.sensorID=sensorID;
		//addSensor(this,sensorID);
	}
	/*public void delete(){
		for(Map.Entry<Integer, SensorIn> entry:sensors.entrySet()){    
	...
	//	return sensors.size();
	//}
	/*private boolean addSensor(SensorIn sensor,int sensorID){
	...
	/*public static SensorIn getSensor(int sensorID){
		return sensors.get(sensorID);
	}
	public static void empty(){
		sensors = null;
		sensors = new HashMap<Integer,SensorIn>();
	}*/
}
