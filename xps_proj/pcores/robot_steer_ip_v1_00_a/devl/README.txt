...
Peripheral Summary:
  ...
  logical library name                       : robot_steer_ip_v1_00_a
  top name                                   : robot_steer_ip
  version                                    : 1.00.a
  type                                       : AXI4LITE slave
...
- XPS interface file(s)
  ...
  data/robot_steer_ip_v2_1_0.mpd
  ...
  data/robot_steer_ip_v2_1_0.pao
...
- ISE project file(s)
  ...
  devl/projnav/robot_steer_ip.xise
...
- XST synthesis file(s)
  ...
  devl/synthesis/robot_steer_ip_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/robot_steer_ip_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/robot_steer_ip_v2_1_0.tcl
