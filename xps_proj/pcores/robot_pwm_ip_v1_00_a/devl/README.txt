...
Peripheral Summary:
  ...
  logical library name                       : robot_pwm_ip_v1_00_a
  top name                                   : robot_pwm_ip
  version                                    : 1.00.a
  type                                       : AXI4LITE slave
...
- ISE project file(s)
  ...
  devl/projnav/robot_pwm_ip.xise
...
- XST synthesis file(s)
  ...
  devl/synthesis/robot_pwm_ip_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/robot_pwm_ip_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/robot_pwm_ip_v2_1_0.tcl
